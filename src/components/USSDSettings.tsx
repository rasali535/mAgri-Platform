                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-neutral-50 rounded-3xl p-6 border border-neutral-100">
                       ...
                       <p className="text-xs text-neutral-500 font-medium mt-4 leading-relaxed">
                          Primary gateway for all mAgri services. Works globally on any GSM network without internet.
                       </p>
                    </div>
                    <div className="bg-neutral-50 rounded-3xl p-6 border border-neutral-100">
              ...
              <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
                 ...
                 <div>
                    ...
                    <p className="text-neutral-400 font-medium leading-relaxed">
                       mAgri uses a dual-redundancy model. When local internet (4G/5G) fails, the platform automatically switches to USSD protocol for session continuity. No data is lost, no session is dropped.
                    </p>
        ...
        <div className="lg:col-span-5 space-y-8">
           ...
           <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-neutral-100">
              ...
              <div className="space-y-6">
                 <div>
                    <p className="text-[10px] font-black text-neutral-400 uppercase tracking-widest mb-1">Infrastructure Key (mARI-IVS)</p>
