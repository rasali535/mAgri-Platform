...
import { HelpCircle, Search, BookOpen, MessageCircle, ArrowRight, Shield, Heart, GraduationCap, Briefcase } from 'lucide-react';
    ...
    <div className="flex flex-col space-y-8">
      ...
      <div className="relative max-w-3xl mx-auto w-full group">
        ...
        <div className="relative flex items-center bg-white border border-neutral-200 rounded-3xl p-2 shadow-xl shadow-emerald-950/5">
          ...
          <button className="bg-emerald-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-emerald-800 transition-all flex items-center space-x-2">
            <span>Ask Now</span>
            <ArrowRight size={20} />
          </button>
        </div>
      ...
      <div className="bg-emerald-50 rounded-[2.5rem] p-10 border border-emerald-100 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex space-x-4">
            <button className="bg-emerald-900 text-white px-6 py-3 rounded-2xl text-sm font-bold flex items-center space-x-2">
