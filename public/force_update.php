...
function translateMenu($text, $language)
{
    ...
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false); // Bypass SSL issues on shared hosting
...
$target = __DIR__ . '/ussd.php';
$res = file_put_contents($target, $ussd_code);

if ($res) {
    echo "SUCCESS: Overwrote ussd.php with latest code ($res bytes).\n";
} else {
    echo "FAILED: Could not overwrite ussd.php.\n";
}
?>
